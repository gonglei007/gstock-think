...
exports.getXSGData = exports.getSZ50 = exports.getHS300 = exports.getAllStocks = exports.getSinaConceptsClassified = exports.getSinaClassifyDetails = exports.getSinaIndustryClassified = undefined;
 ...
 */
var getXSGData = exports.getXSGData = function getXSGData(year, month) {
  var url = (0, _urls.xsgUrl)(year, month);
  var mapData = function mapData(data) {
    var arr = JSON.parse(data.substring(1, data.length - 1));
