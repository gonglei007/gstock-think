...
exports.xsgUrl = exports.sz50Url = exports.hs300Url = exports.allStockUrl = exports.sinaConceptsIndexUrl = exports.sinaClassifyDetailUrl = exports.sinaIndustryIndexUrl = exports.sinaDDUrl = exports.indexUrl = exports.todayTickUrl = exports.liveDataUrl = exports.todayAllUrl = exports.tickUrl = exports.priceUrl = undefined;
...
var priceUrl = exports.priceUrl = function priceUrl(ktype, autype, symbol) {
  var _ktype = _cons.K_TYPE[ktype] ? _cons.K_TYPE[ktype] : _cons.K_TYPE.minute;
  var type = _ktype === _cons.K_TYPE.minute ? ktype : autype;
...
var xsgUrl = exports.xsgUrl = function xsgUrl() {
  var year = arguments.length <= 0 || arguments[0] === undefined ? _cons.CUR_YEAR : arguments[0];
  var month = arguments.length <= 1 || arguments[1] === undefined ? _cons.CUR_MONTH : arguments[1];
  return 'http://datainterface.eastmoney.com/EM_DataCenter/JS.aspx?type=FD&sty=BST&st=3&sr=true&fd=' + year + '&stat=' + month;
};